...
// Database & Configuration Hooks
export { useSupabaseConfig } from './useSupabaseConfig';
export { useDatabase } from './useDatabase';
export { useAuthWithFallback } from './useAuthWithFallback';

// Import hooks for categories
...
export const HookMetadata = {
  ...
  useFileManager: {
    category: 'advanced-features',
    phase: 3,
    description: 'Dolphin-inspired file system integration with drag&drop',
    dependencies: [],
    features: ['drag-drop', 'search-filter', 'multi-view-modes']
  }
} as const;
...
export const UsagePatterns = {
  ...
  advanced: ['useCanvasNavigation', 'usePanelManager', 'useMinimap', 'useContextManager', 'useWindowManager', 'useKeyboardShortcuts', 'useAIAgent', 'useTerritoryManager', 'useClipboardManager', 'useFileManager'],
